...
export default function ImportPage() {
    ...
    const handleQuickComplete = (order: IGoldTransaction) => {
        ...
        router.patch(`/admin/imports/${order.id}/complete`, {}, {
            onSuccess: () => {
                toast.success(`Đơn hàng #${order.id} đã được hoàn thành!`);
            },
            onError: () => {
    ...
    const handleQuickCancel = (order: IGoldTransaction) => {
        ...
        router.post(`/admin/imports/${order.id}/cancel`, {
    ...
    const handleQuickProcess = (order: IGoldTransaction) => {
        ...
        router.patch(`/admin/imports/${order.id}/process`, {}, {
            onSuccess: () => {
                toast.success(`Đơn hàng #${order.id} đã chuyển sang đang xử lý!`);
            },
            onError: () => {
    ...
    const handleView = (order: IGoldTransaction) => {
        router.visit(`/admin/imports/${order.id}`);
    };
    ...
    const handleBulkAction = (action: string) => {
        ...
        router.post('/admin/imports/bulk-update-status', {
...
ImportPage.layout = (page: React.ReactNode) => (
